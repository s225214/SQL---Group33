...
DELIMITER $$
CREATE FUNCTION Fine(return_date DATE, due_date DATE) 
RETURNS DECIMAL(5,2) DETERMINISTIC
BEGIN
    DECLARE fine DECIMAL(5,2);
    IF return_date > due_date THEN
        SET fine = DATEDIFF(return_date, due_date) * 2.00;
    ELSE
        SET fine = 0.00;
    END IF;    
    RETURN fine;
...
SELECT Fine('2025-04-12', '2025-04-05'); -- Expected result: 14 (7 days × $2)
